    ...
    return (
        <div className="bg-stone-900/25 relative p-0 border border-stone-700/75 hover:border-stone-500/75 transition-colors ease-out group">
            ...
            <div className="p-6">
                ...
                <p className="text-xs font-light font-mono tracking-wider uppercase text-stone-400 mb-4 pb-8 border-b border-b-stone-700/75">{maskVIN(vehicle.trim)}</p>

                <p className="text-stone-400 text-xs/2">
                    <span className="text-xs font-light tracking-wider uppercase text-stone-400 lh-1">Kilométrage</span>
                    <br />
