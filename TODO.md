            ...
            <table class="main" role="presentation">
                ...
                <tr>
                    <td class="content" style="border-radius: 0px !important;">
                        ...
                        <p>
                            Une demande de réinitialisation a été effectuée pour
                            votre garage numérique <strong>VinTrace</strong>.
                            Cliquez sur le bouton ci-dessous pour configurer
                        ...
                        <p style="font-size: 13px; margin-bottom: 0;">
                            Si vous n'avez pas sollicité cette action, vous
                            pouvez ignorer cet email.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="footer">&copy; 2026 VinTrace</td>
                </tr>
            </table>
        </center>
    </body>
